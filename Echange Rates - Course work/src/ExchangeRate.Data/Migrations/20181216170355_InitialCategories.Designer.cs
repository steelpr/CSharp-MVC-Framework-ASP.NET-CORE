...
namespace ExchangeRate.Data.Migrations
{
    ...
    [Migration("20181216170355_InitialCategories")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExchangeRate.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ExchangeRate.Data.Models.Article", b =>
                {
                    b.HasOne("ExchangeRate.Data.Models.Category", "Category")
                        .WithMany("Articles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ExchangeRate.Data.Models.ExchangeRateUser")
                        .WithMany()
